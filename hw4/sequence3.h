// Provided by: Sumaiya Ahmed
// Email Address: sahmed040@citymail.cuny.edu
// FILE: sequence3.h
...
namespace main_savitch_5
{
    ...
    private:
       ...
       node *m_cursor; // keeps track of current node
       node *m_precursor; // keeps track of the node before the current node
